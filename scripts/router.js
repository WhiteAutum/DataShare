...
angular.module('mainrouter', [
  ...
  .config(function ($stateProvider) {
    $stateProvider
      ...
      .state('app.dataReceived', {
        url: '/dataReceived',
        views: {
          "content": {
            templateUrl: 'views/blockchain/management/DataReceived.html',
      ...
      .state('app.rsa', {
        ...
        views: {
          "content": {
            templateUrl: 'views/blockchain/accessControl/rsa.html',
            controller: 'rsa'
          }
        }
      })
      .state('app.get_rsa', {
        ...
        views: {
          "content": {
            templateUrl: 'views/blockchain/accessControl/get_rsa.html',
            controller: 'get_rsa'
          }
        }
      })
      .state('app.cap', {
        ...
        views: {
          "content": {
            templateUrl: 'views/blockchain/accessControl/cap.html',
            controller: 'cap'
          }
        }
      })
      .state('app.revoke', {
        ...
        views: {
          "content": {
            templateUrl: 'views/blockchain/accessControl/revoke.html',
            controller: 'revoke'
          }
        }
      });
