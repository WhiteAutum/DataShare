...
//     if (requestData(dataName, requester, password)) {
//       alert("请求成功！");
//       return;
//     }
//     alert("请求失败！");
...
//  * @returns {boolean}
//  */
// function requestData(dataName, requester, password) {
...
//     //发送请求
//     //2019.4.11号修改
//     contractInstance.AddRequestObject(formatBytes(dataName), requester , {
//       from: requester,
//       gas: 80000000
//     });
//   } catch (err) {
...
//     // }
//     //获取当前请求备注信息
//     //修改合约  getDataRequest 仅使用数据名就可以取出请求对象
//     //  var requestContractInstance = requestContract.at(contractInstance.getDataRequest.call(dataName));
